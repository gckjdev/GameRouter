...
public class DBConstants {
    ...
    // buy id, user id, coins amount, create date, coins balance, cost money, result  
    ...
    // buy id, user id, item type, create date, amount, amount after buy, cost coins, result
...
//	public static final String F_DESC = "desc";
	...
	public static final int C_DEFAULT_BALANCE = 100;
	public static final int C_DEFAULT_TIPS_AMOUNT = 3;
